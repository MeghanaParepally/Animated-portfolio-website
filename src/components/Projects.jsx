...
const Projects = () => {
    ...
    return(
       <section className="px-6 py-10" id="work">
           <h1 className="text-4xl md:text-6xl front-medium tracking-tight md-10">Work</h1>
